...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objects = [this.plane, this.pyramid, this.cone, this.tangram, this.unit_cube, this.prism, this.cylinder];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = {
                 'Plane': 0 , 'Pyramid': 1, 'Cone': 2,
                 'Tangram': 3, 'Unit Cube': 4, 'Prism': 5, 'Cylinder': 6};
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.4, 0.25, 0.2, 1.0);
        this.material4.setDiffuse(0.6, 0.5, 0.4, 1.0);
        this.material4.setSpecular(0.4, 0.4, 0.4, 1.0);
